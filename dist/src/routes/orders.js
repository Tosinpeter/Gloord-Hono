...
ordersRoute.post("/", async (c) => {
    ...
    const { delivery_first_name, delivery_email, delivery_address, delivery_city, delivery_postal_code, delivery_country, subtotal_cents, shipment_cents, insurance_cents, total_cents, card_last4, } = body;
    if (!delivery_first_name ||
        ...
        !card_last4) {
        return c.json({ success: false, error: "missing_required_fields", message: "Missing required order fields" }, 400);
    }
