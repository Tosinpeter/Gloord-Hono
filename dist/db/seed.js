...
async function seed() {
    ...
    const couponRows = [
        { code: 'WELCOME10', discount_type: 'percent', discount_value: 10, min_order_cents: 500, usage_limit: 1000 },
        { code: 'SAVE20', discount_type: 'percent', discount_value: 20, min_order_cents: 2000, usage_limit: 500 },
        { code: 'FLAT50', discount_type: 'fixed', discount_value: 5000, min_order_cents: 10000, usage_limit: 200 }, // $50 off
    ];
