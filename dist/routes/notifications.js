...
notificationsRoute.post("/seed", async (c) => {
    ...
    const seeds = [
        { user_id, title: "Your Prescription is Ready", subtitle: "Download and consult a local pharmacy", notification_type: "prescription_ready", createdAt: now },
        { user_id, title: "Doctor review completed", subtitle: "Your treatment plan is approved", notification_type: "review_completed", createdAt: hourAgo },
        { user_id, title: "Time for your night routine", subtitle: "Consistency helps your skin heal faster", notification_type: "night_routine", is_read: true, createdAt: yesterday },
        { user_id, title: "Your order has been shipped", subtitle: "Track your delivery", notification_type: "order_shipped", is_read: true, createdAt: twoDaysAgo },
    ];
